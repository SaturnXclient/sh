...
const categories = ['Blouses', 'Shirts', 'Evening Wear', 'Accessories'];
const filters = {
  size: ['XS', 'S', 'M', 'L', 'XL'],
  color: ['White', 'Blue', 'Black', 'Pink', 'Floral'],
...
const womenProducts = [
  {
    ...
    description: 'Pure silk crepe de chine',
    price: 495,
    image: 'https://images.unsplash.com/photo-1551163943-3f6a855d1153?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80'
  },
  {
    id: 202,
    name: 'The Evening Blouse',
    description: 'Embellished silk georgette',
    price: 595,
    image: 'https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80'
  },
  {
    id: 203,
    name: 'The Classic White',
    description: 'Cotton poplin shirt',
    price: 345,
    image: 'https://images.unsplash.com/photo-1604904612715-47bf9d9bc670?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80'
  },
    ...
    <main>
      ...
      <section className="relative h-[70vh] bg-stone-950">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1483985988355-763728e1935b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80"
        ...
        <div className="relative h-full flex items-center justify-center text-center text-white px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="font-display text-5xl md:text-7xl mb-8">Women's Collection</h1>
            <p className="text-xl md:text-2xl mb-12 font-light tracking-wide opacity-90">
              Elegance redefined through timeless pieces and contemporary designs
            </p>
